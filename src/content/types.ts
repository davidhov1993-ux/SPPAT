...
export type Block = { id?: string; Type?: string; Eyebrow?: string; H1?: string; H2?: string; H3?: string; Body?: string; CTA?: string; 'CTA URL'?: string; 'Primary CTA'?: string; 'Primary CTA URL'?: string; Button?: string; URL?: string; Visual?: string; ALT?: string; bullets?: string[]; cards?: Card[]; Filters?: string }
