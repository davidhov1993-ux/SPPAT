...
const tegelwerkImages: Record<string, { src: string; alt: string }> = {
  '/tegelwerk/': {
    src: '/references/WhatsApp Image 2025-05-30 at 21.24.04 (2).jpeg',
    alt: 'Professioneel tegelwerk met strakke voeguitlijning'
  },
  '/tegelwerk/badkamer-tegelen/': {
    src: '/references/WhatsApp Image 2025-05-30 at 21.24.03 (3).jpeg',
    alt: 'Badkamer tegelen met strakke hoeken en afschot'
  },
  '/tegelwerk/vloer-tegelen/': {
    src: '/references/WhatsApp Image 2025-05-30 at 21.24.02 (4).jpeg',
    alt: 'Vlak gelegde tegelvloer zonder lippage'
  },
  '/tegelwerk/wand-tegelen/': {
    src: '/references/WhatsApp Image 2025-05-30 at 21.24.04 (4).jpeg',
    alt: 'Loodrecht uitgelijnde wandtegels in sanitaire ruimte'
  },
  '/tegelwerk/keuken-tegelen/': {
    src: '/references/WhatsApp Image 2025-05-30 at 21.24.02 (3).jpeg',
    alt: 'Keuken achterwand betegeld met vakkundige kitvoeg'
  }
}

export default function TegelwerkPage({ page }: { page: Page }) {
  const isHub = page.url === '/tegelwerk/'
  const hero = page.hero
  const media = tegelwerkImages[page.url]
